...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-2">
            ...
            <a href="#" id="addProduct" class="list-group-item"><span class="glyphicon glyphicon-plus"></span> 添加商品</a>
        </div>
            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${ps}" var="p" varStatus="s">
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="admin_product_edit?id=${p.id}" class="btn btn-default">修改</a><a href="#" class="btn btn-default">下架</a><a
